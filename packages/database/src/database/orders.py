...
from database.enums import OrderStatus, POStatus
from database.mixins import AuditTimestampMixin
...
if TYPE_CHECKING:
    ...
    from database.logistics import LeadtimeModel, Shipment, Supplier, Warehouse
