...
def get_translated_algorithms(algorithm_numbers: Iterable[str], signatures_only: bool = False) -> list[dict[str, str]]:
    ...
    for algorithm_number in algorithm_numbers:
        translated_algorithm = get_translated_algorithm(algorithm_number)
