...
class ToolRegistry:
    ...
    def tools(self) -> dict[str, BaseTool]:
        """For tests and debugging: get all registered tools."""
        return self._tools
    ...
    def list_tools(self, category: str | None = None) -> list[BaseTool]:
        ...
        if category:
            ...
            logger.debug("tools_filtered_by_category", category=category, count=len(tools))
    ...
    def get_openai_functions(self, categories: list[str] | None = None) -> list[dict[str, Any]]:
        """
        ...
        if categories:
            ...
            logger.debug("openai_functions_filtered", categories=categories, tool_count=len(tools))
