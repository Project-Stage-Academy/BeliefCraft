...
class SensorManager:
    ...
    def _get_positive_inventory(self, warehouse: Warehouse) -> List[InventoryBalance]:
        ...
        """
        return self.session.query(InventoryBalance).join(Location).filter(
    ...
    def _create_observation(self, sensor: SensorDevice, balance: InventoryBalance,
        ...
        """
        observed_qty, confidence, is_missing = self._calculate_observed_values(sensor, balance.on_hand)
    ...
    def _calculate_observed_values(self, sensor: SensorDevice, actual_qty: float) -> Tuple[
    ...
    def _persist_observation(self, sensor: SensorDevice, balance: InventoryBalance,
                             observed_qty: Optional[float], confidence: float,
                             is_missing: bool, date: datetime) -> None:
        """
