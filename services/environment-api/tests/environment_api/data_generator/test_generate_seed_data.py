...
import pytest
from environment_api.data_generator.generate_seed_data import SimulationRunner
...
class TestSimulationRunner:
    @patch("environment_api.data_generator.generate_seed_data.Base.metadata")
    ...
    @patch("environment_api.data_generator.generate_seed_data.WorldBuilder")
    @patch("environment_api.data_generator.generate_seed_data.settings")
    ...
    @patch("environment_api.data_generator.generate_seed_data.SimulationEngine")
    ...
    @patch("environment_api.data_generator.generate_seed_data.SessionLocal")
