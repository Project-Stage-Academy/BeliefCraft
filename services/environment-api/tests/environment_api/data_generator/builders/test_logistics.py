...
import pytest
from database.enums import LeadtimeScope, TransportMode
from database.models import LeadtimeModel, Warehouse
...
class TestLogisticsBuilder:
    ...
    @patch("environment_api.data_generator.builders.logistics.settings")
    @patch("environment_api.data_generator.builders.logistics.random")
