...
import pytest
from database.enums import DeviceType, LocationType
from database.models import Location, SensorDevice, Warehouse
from environment_api.data_generator.builders.layout import DockBuilder, ZoneBuilder
...
class TestZoneBuilder:
    @patch("environment_api.data_generator.builders.layout.random")
    ...
    @patch("environment_api.data_generator.builders.layout.settings")
    @patch("environment_api.data_generator.builders.layout.random")
