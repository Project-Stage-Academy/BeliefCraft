...
import pytest
from database.enums import LocationType, ShipmentStatus
from database.models import Location, POLine, PurchaseOrder, Shipment
from environment_api.data_generator.logic.inbound import InboundManager
from environment_api.data_generator.logic.inventory import ReceiptCommand
...
def inbound_manager(mock_session, mock_ledger):
    ...
    """
    with patch(
        "environment_api.data_generator.logic.inbound.InventoryLedger", return_value=mock_ledger
    ):
