...
def world_builder(mock_session):
    ...
    """
    with (
        patch("environment_api.data_generator.world_builder.InfrastructureBuilder"),
        patch("environment_api.data_generator.world_builder.CatalogBuilder"),
        patch("environment_api.data_generator.world_builder.LogisticsBuilder"),
    ):
...
class TestWorldBuilder:
    def test_initialization_seeds_logic(self, mock_session):
        ...
        seed = 12345
        with (
            patch("environment_api.data_generator.world_builder.random.seed") as mock_rseed,
            patch("environment_api.data_generator.world_builder.Faker") as mock_faker_cls,
        ):
    ...
    @patch("environment_api.data_generator.world_builder.settings")
